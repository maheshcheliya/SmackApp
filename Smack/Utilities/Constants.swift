...
let BASE_URL = "http://192.168.2.37:3005/v1/"
...
let NOTIFICATION_CHANNELS_LOADED = Notification.Name(rawValue: "channelsLoaded")
let NOTIFICATION_CHANNEL_SELECTED = Notification.Name(rawValue: "channelSelected")
